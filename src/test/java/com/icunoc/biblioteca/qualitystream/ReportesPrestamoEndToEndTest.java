...
public class ReportesPrestamoEndToEndTest {
    ...
    public void RevisarPrestamoMenuButtonTestSuccess(){
        ...
        WebElement button2 = driver.findElement(By.name("reportesPrestamo"));
        button2.click();
        ...
        Assertions.assertEquals("Mis Reportes (Prestamos Finalizados)", elementNewView.getText());
