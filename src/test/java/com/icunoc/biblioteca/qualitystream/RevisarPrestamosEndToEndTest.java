...
public class RevisarPrestamosEndToEndTest {
    ...
    @Test
    public void RevisarPrestamoMenuButtonTestSuccess(){
        //Arrage
        ...
        WebElement button2 = driver.findElement(By.name("revisarPrestamo"));
        button2.click();
        ...
        // Usamos la espera explícita bajo una condicion esperada, en este caso esperamos hasta que nos redirija a la nueva url de un user admin
        wait2.until(ExpectedConditions.urlToBe(URL_APP+"revisarPrestamos"));
        ...
        By cardTittle = By.id("listaPrestamo");
        ...
        Assertions.assertEquals("Lista de Prestamos Activos", elementNewView.getText());
